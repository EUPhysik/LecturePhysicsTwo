...
Schematische Darstellung des inneren Photoeffektes
 ...
 ```{figure} Bilder/Photodiode-closeup.jpg
---
width: 80%
alt: Photoeffekt
name: R_foto
...
Wird der Fotowiderstand mit Licht mit dieser oder einer geringeren Wellenlänge bestrahlt, werden Elektronen aus dem Valenzband in das Leitungsband gehoben und die Photodiode erzeugt eine Spannung.B